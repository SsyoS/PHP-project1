...
class binhluan{
    ...
    function Insertbinhluan($mabl,$maxe,$makh,$ngaybl,$noidung,$solike,$sodislike)
    {
    $db = new connect();
    $query="insert into binhluan1(mabl,maxe,makh,ngaybl,noidung,solike,sodislike)
    values(null,'$maxe','$makh','$ngaybl','$noidung','$solike',$sodislike)";
    $db->exec($query);
    }
    ...
    function getCount($maxe)
    {
        $db = new connect();
        $select = "select count(mabl) from binhluan1 where maxe=$maxe ";
